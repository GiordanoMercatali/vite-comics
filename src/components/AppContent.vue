<template lang="">
    <main>
        ...
        <div class="section products">
            <div class="row">
                <div class="col" v-for="(product, indexProduct) in productsList" :key="product.series">
                    <ComicCard :propThumb="product.thumb" :propPrice="product.price" :propSeries="product.series" />
                </div>
            </div>
        </div>
